...
export function DashboardShell() {
  ...
  const handleAnalyticsChange = (nextAnalytics: SolverAnalytics, nextPerformance: AlgorithmPerformanceMap) => {
    ...
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-[1800px] flex-col gap-4 px-4 py-4 sm:px-6 lg:gap-5 lg:px-8 lg:py-6">
        ...
        >
          ...
          <InsightsSidebar className="order-3 h-full xl:order-3" analytics={analytics} performance={performance} />
        </motion.section>
